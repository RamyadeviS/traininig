...
<h1> &emsp;&emsp;&emsp;&emsp;E-Pass User List</h1> 
    <form action="/EpassPendingList" method="Get">
      
  <% HttpSession session2=request.getSession();
   List<EpassForm>listEpassForm=(List<EpassForm>)request.getAttribute("List_Pending");
   %>
