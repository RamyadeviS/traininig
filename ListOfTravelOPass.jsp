...
<h1>&emsp;&emsp;&emsp;&emsp;Travel Pass User List</h1>
...
<% HttpSession seesion=request.getSession();
 ...
 %>
    ...
    <caption>view</caption>
       ...
       <tr>
         ...
         <td><input type ="checkbox"
          value="<%=TravelPass.getApplicationNumber() %>" name="checkbox">
          <%=TravelPass.getApplicationNumber() %>
         </td>
         </form>
   ...
   <button type="Submit">Approve </button>&emsp;&emsp;&emsp;
 <div class="Reject">
