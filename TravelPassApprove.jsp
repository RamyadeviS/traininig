...
<h1>&emsp;&emsp;&emsp;&emsp;Travel Pass Approve List</h1>
<form action="/TravelPassApprove" method="Get">

<% HttpSession seesion=request.getSession();
 List<TravelEpassForm>listTravelPass=(List<TravelEpassForm>)request.getAttribute("Travel_Approve");
 %>
