...
<h1>&emsp;&emsp;&emsp;&emsp;Travel Pass Pending List</h1>
<form action="/TravelPassPending" method="Get">

<% HttpSession seesion=request.getSession();
 List<TravelEpassForm>listTravelPass=(List<TravelEpassForm>)request.getAttribute("Travel_Pending");
 %>
