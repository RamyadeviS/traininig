...
-- create a table
CREATE TABLE customers(customer_id number(10),customer_name varchar(15),address varchar(20),website varchar(10),credit_limit number(13),phone_number number(20));
-- insert data
INSERT INTO customers VALUES (11,'ramya','chennai','www.com',4657,9345671190);
INSERT INTO customers VALUES (14,'jaya','madurai','ram.in',4745,9876543697);
INSERT INTO customers VALUES (13,'suryaya','kerala','www.insta',4000,9345678556);
--fetch data
