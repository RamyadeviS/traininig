...
<h1> &emsp;&emsp;&emsp;&emsp;E-Pass Reject List</h1> 
<form action="/EpassRejectList" method="Get">  
  <% HttpSession session2=request.getSession();
   List<EpassForm>listEpassForm=(List<EpassForm>)request.getAttribute("List_Reject");
   %>
